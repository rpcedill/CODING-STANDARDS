...
public class Calculator {
	...
	/**
	 * Second function
	 * @param first is the first value for the operation
	 * @param second is the second value for the operation
	 * @param operator is a value which tell us which operation case will be done
	 * @return operation's result or error message
	 */
